...
namespace TicTacToe
{
    internal class Program
    {
        /*     Use a loop for horizontal and vertical checks: To check for horizontal and vertical wins, 
               ...
               Returning the result: If a winning condition is met in any of the cases (horizontal, vertical, or diagonal), the Checker method should return true,
               indicating a winner. If none of the conditions are met after all checks are complete, the method should return false, indicating no winner.*/
